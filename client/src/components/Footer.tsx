  ...
  return (
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Simplifying the way you book appointments with institutions that matter to you.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Medical</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-gray-400 text-sm text-center">
          <p>&copy; {new Date().getFullYear()} Qpass. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
